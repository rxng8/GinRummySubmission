...
public class MediumPlayerHE implements GinRummyPlayer {
	...
	public float OPPO_CARD_PROB_WEIGHT;
	public float CARD_DEADWOOD_WEIGHT;
	...
	public MediumPlayerHE() {
		this.HIT_CARD_VALUE_THRESHOLD = 20.7f;
		this.OPPO_CARD_PROB_WEIGHT = 1.0f;
		this.CARD_DEADWOOD_WEIGHT = 0.3f;
	}
	
	public MediumPlayerHE(float HIT_CARD_VALUE_THRESHOLD, float OPPO_CARD_PROB_WEIGHT, float CARD_DEADWOOD_WEIGHT) {
