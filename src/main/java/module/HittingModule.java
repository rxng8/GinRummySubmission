...
//			String modelJson =  HittingModule.class.getClass().getResource("/model/" + file_name + "_config.json").toExternalForm();

			System.out.println(modelJson);

			String modelWeights = new ClassPathResource("./model/" + file_name + "_weights.h5").getFile().getPath();
//			String modelWeights =  HittingModule.class.getClass().getResource("/model/" + file_name + "_weights.h5").toExternalForm();
